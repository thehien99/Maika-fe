    ...
    <div className='w-full h-full bg-[#000EA9]'>
      <div className='container p-24 flex flex-col justify-center items-center gap-16'>
        <div className='text-[#fff] w-[80%] flex flex-col justify-center items-center gap-6 text-center'>
          <h1 className='font-bold xs:text-[22px]'>Trải nghiệm ngay sức mạnh của trợ lý AI Marketing và kiểm nghiệm ngay hiệu quả!</h1>
          <h5 className='font-semibold xs:text-[20px]'>Dùng thử miễn phí. Không yêu cầu thẻ tín dụng.</h5>
        </div>
        <div className='text-white md:gap-5 xs:gap-5 flex justify-center items-center xs:flex-col xs:w-full'>
